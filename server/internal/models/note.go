...
type Note struct {
	...
	Title     string    `gorm:"type:text;not null;default:Untitled;index:idx_notes_title_trgm,class:GIN,expression:title gin_trgm_ops"`
	Content   string    `gorm:"type:text;not null;default:'';index:idx_notes_content_trgm,class:GIN,expression:content gin_trgm_ops"`
