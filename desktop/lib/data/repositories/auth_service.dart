...
// Drift generates a `User` row class from the Users table; the domain model
// takes precedence (same approach as the mobile app).
...
class AuthService {
  ...
  Future<AuthResponse> login(String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      final displayName =
          (authResponse.user.name != null && authResponse.user.name!.isNotEmpty)
