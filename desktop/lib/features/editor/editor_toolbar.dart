...
class DesktopEditorToolbar extends StatefulWidget {
  ...
  const DesktopEditorToolbar({super.key, required this.editorState});
...
class _DesktopEditorToolbarState extends State<DesktopEditorToolbar> {
  ...
  @override
  Widget build(BuildContext context) => _ToolbarScaffold(state: this);
}

class _ToolbarScaffold extends StatelessWidget {
  final _DesktopEditorToolbarState state;

  const _ToolbarScaffold({required this.state});
      ...
      child: SingleChildScrollView(
        ...
        child: Row(children: [
          ...
          _ToolbarButton(
            ...
            tooltip: 'Underline (⌘U)',
            onTap: () =>
                state._toggleInline(AppFlowyRichTextKeys.underline),
          ),
          _ToolbarButton(
            label: 'S',
            ...
            onTap: () =>
                state._toggleInline(AppFlowyRichTextKeys.strikethrough),
          ),
          ...
          _ToolbarButton(
            ...
            tooltip: 'Checkbox',
            onTap: () => state._toggleBlock(TodoListBlockKeys.type,
