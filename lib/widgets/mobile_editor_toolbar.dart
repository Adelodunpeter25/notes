...
class MobileEditorToolbar extends StatefulWidget {
  ...
  @override
  State<MobileEditorToolbar> createState() => _MobileEditorToolbarState();
}

class _MobileEditorToolbarState extends State<MobileEditorToolbar> {
