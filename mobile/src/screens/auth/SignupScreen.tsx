...
export function SignupScreen() {
  ...
  const submit = () => {
    ...
    signupMutation.mutate({ name: nameValue || undefined, email: emailValue, password });
  };
          ...
          <View>
            <View className="mb-3">
              <TextInput
                ...
                className="rounded-xl border border-border bg-background px-4 py-3 text-[16px] text-text"
              />
            </View>
